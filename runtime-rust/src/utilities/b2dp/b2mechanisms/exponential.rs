...
use crate::utilities::b2dp;
use b2dp::b2utilities::exactarithmetic::{ArithmeticConfig, normalized_sample, randomized_round};
use b2dp::b2utilities::params::Eta;
...
/// incoming flag state.**
pub fn exponential_mechanism<T, R: ThreadRandGen + Copy, F: Fn(&T)->f64>
        ( eta: Eta, 
          outcomes: &Vec<T>, 
          utility: F,
          utility_min: i64, 
...
mod tests {
    use super::*;
    use crate::utilities::b2dp::b2utilities::randomness::GeneratorOpenSSL;
